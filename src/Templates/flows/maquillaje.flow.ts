...
const DEFAULT_PROFESIONAL = "BARBARA";
const DEFAULT_DURATION = 1; // 1 hora
const DEFAULT_SERVICIO = "LIFTING DE PESTAÑAS Y LAMINADO DE CEJAS"
...
const maquillajeflow = addKeyword(EVENTS.ACTION)
    ...
    .addAnswer("Confirmas la fecha propuesta? Responde únicamente con un 'si' o 'no'", { capture: true }, async (ctx, ctxFn) => {
        ...
        return ctxFn.gotoFlow(cita3);
    });

const cita3 = addKeyword(EVENTS.ACTION)
