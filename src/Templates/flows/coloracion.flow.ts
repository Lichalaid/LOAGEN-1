...
const DEFAULT_SERVICIO = "Miropigmentacion de Cejas"
...
const coloracionflow = addKeyword(EVENTS.ACTION)
    ...
    .addAnswer("Confirmas la fecha propuesta? Responde únicamente con un 'si' o 'no'", { capture: true }, async (ctx, ctxFn) => {
        ...
        return ctxFn.gotoFlow(cita4);
    });

const cita4 = addKeyword(EVENTS.ACTION)
