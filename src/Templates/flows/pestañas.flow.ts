...
const DEFAULT_SERVICIO = "DEPILACION"
...
const pestañasflow = addKeyword(EVENTS.ACTION)
    ...
    .addAnswer("Confirmas la fecha propuesta? Responde únicamente con un 'si' o 'no'", { capture: true }, async (ctx, ctxFn) => {
        ...
        return ctxFn.gotoFlow(cita2);
    });

const cita2 = addKeyword(EVENTS.ACTION)
